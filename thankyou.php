...
<?php $page_title = 'Thank You | Code Panda Computers'; ?>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-8 text-center">
                <div class="p-5 bg-white border rounded-3 shadow-sm">
                    ...
                    <div class="mt-4">
                        <a href="https://core.code-panda.online" class="template-btn primary-btn rounded-pill">Go to Client Area <i class="fa fa-arrow-right"></i></a>
                    </div>
                </div>
            </div>
        </div>
