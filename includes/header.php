...
<head>
    ...
    <meta name="twitter:title" content="Code Panda Computers - No pain when you host with us." />
    <meta name="twitter:description" content="No pain when you host with us." />
    <meta name="twitter:image" content="#" />
    <meta property="og:url" content="index.html" />
    <meta property="og:description" content="Code Panda Computers provides fast, reliable, affordable web hosting with 99.9% uptime guaranteed." />
                    ...
                    <div class="row align-items-center">
                        <div class="col-lg-3 col-8">
                            <div class="logo-wrapper">
                                <a href="index.php" class="logo-black"><img src="assets/img/logo.png" alt="<?php echo $site_name; ?>" class="logo"></a>
                            </div>
                        </div>
                                            ...
                                            <ul class="submenu-wrapper menu-list">
                                                <li>
                                                    <a href="contact.php">
                                                        <div class="menu-list-wrapper d-flex align-items-center">
                                                            ...
                                                            <div class="menu-list-content-right ms-3">
                                                                <h6>Contact us</h6>
                                                                <span>Get intouch for assistance</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
                                                <li>
                                                    <a href="report-abuse.php">
                                                        <div class="menu-list-wrapper d-flex align-items-center">
                                                            <span class="icon-wrapper"><i class="fa-solid fa-circle-exclamation"></i></span>
                                                            <div class="menu-list-content-right ms-3">
                                                                <h6>Report Abuse</h6>
                                                                <span>Report any form of abuse</span>
                                                            </div>
                                                        </div>
                                                    </a>
                                                </li>
    ...
    <div class="mobile-menu position-fixed bg-white deep-shadow p-0">
        <div class="bg-primary position-relative pb-3 pt-5 px-4">
            ...
            <a href="index.php" class="logo-wrapper">
                <img src="assets/img/logo.png" alt="logo" class="logo w-100" style="max-width:240px">
            </a>
        </div>
                ...
                <li class="has-submenu">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="report-abuse.php">
                                <div class="menu-list-wrapper d-flex align-items-center">
                                    <span class="icon-wrapper"><i class="fa fa-exclamation"></i></span>
                                    <div class="menu-list-content-right ms-3">
                                        <h6>Report Abuse</h6>
